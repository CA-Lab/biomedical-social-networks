...
that referees to a historical balance between average utility and the average
strength of the connections with its neighbors. This is so because we assume that
...
far. In every simulation step, each player will play both games
  ...
  assessing the overall situation of its relationships. This may sound odd, since
...
%resarchers and their communities.\\
 ...
 To close this article, we would like to comment on three
  ...
  We believe that the the situation just referred is also
