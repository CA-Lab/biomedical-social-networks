...
\begin{abstract}
  ...
  researchers' social and political power, and by their
  ...
  the strengthening or weakening of collaboration interactions among
  partners, as scientists cooperate or defect in order to gain access
  to resources shared by others. The network is based on data about projects
...
{\color{red}In the context of our paper, utility represents
  ...
  % TODO: este ejemplo de defection no es nada claro:
  %
